...
public interface ServerDAO {
	...
	public void newReports(@Param("round")int round,@Param("apitype")String apitype,@Param("apiname")String apiname,@Param("datatag")String datatag,
	...
	public List<String> getRunedTestCase(@Param("round")int round,@Param("apiname")String apiname);
}
