...
//大类资产配置
public class get_interval_industry_risk_exposure_timing {
	...
	public void get_interval_industry_risk_exposure_timing(Element testcase,Method method) throws Exception{
