...
public class get_press_clearance_max_cash {
	private String res;
	...
	public void get_press_clearance_max_cash(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_press_clearance_max_cash_cycle(testcase.attributeValue("name"));
	...
	private String get_press_clearance_max_cash_cycle(String testcasename) throws Exception{
