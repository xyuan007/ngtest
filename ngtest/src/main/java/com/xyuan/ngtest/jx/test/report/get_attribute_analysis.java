...
public class get_attribute_analysis {
	private String res;
	...
	public void get_attribute_analysis(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_attribute_analysis_cycle(testcase.attributeValue("name"));
	...
	private String get_attribute_analysis_cycle(String testcasename) throws Exception{
