...
public class get_total_achieve {
	private String res;
	...
	public void get_total_achieve(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_total_achieve_cycle(testcase.attributeValue("name"));
	...
	private String get_total_achieve_cycle(String testcasename) throws Exception{
