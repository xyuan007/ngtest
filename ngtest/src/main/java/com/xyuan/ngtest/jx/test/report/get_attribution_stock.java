...
public class get_attribution_stock {
	private String res;
	...
	public void get_attribution_stock(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_attribution_stock_cycle(testcase.attributeValue("name"));
	...
	private String get_attribution_stock_cycle(String testcasename) throws Exception{
