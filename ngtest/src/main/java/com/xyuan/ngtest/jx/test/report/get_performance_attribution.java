...
public class get_performance_attribution {
	private String res;
	...
	public void get_performance_attribution(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_performance_attribution_cycle(testcase.attributeValue("name"));
	...
	private String get_performance_attribution_cycle(String testcasename) throws Exception{
