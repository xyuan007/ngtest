...
public class get_market_risk_profile {
	private String res;
	...
	public void get_market_risk_profile(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_market_risk_profile_cycle(testcase.attributeValue("name"));
	...
	private String get_market_risk_profile_cycle(String testcasename) throws Exception{
