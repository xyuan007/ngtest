...
public class get_combination_asset {
	private String res;
	...
	public void get_combination_asset(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_combination_asset_cycle(testcase.attributeValue("name"));
	...
	private String get_combination_asset_cycle(String testcasename) throws Exception{
