...
public class get_risk_pressure_drop {
	private String res;
	...
	public void get_risk_pressure_drop(Element testcase,Method method) throws Exception{
...
//		//多次循环直到拿到结果
		while(PublicDataHelper.getIns(Thread.currentThread().getId()).getCasedata().getCycleFlag().equals("true"))
			this.res = get_data_pressure_test(testcase.attributeValue("name"));
	...
	private String get_data_pressure_test(String testcasename) throws Exception{
